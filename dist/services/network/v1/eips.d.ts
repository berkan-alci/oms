...
export interface PublicIP {
     ...
     * - ERROR (Exceptions)
     */
    status: 'FREEZED' | 'BIND_ERROR' | 'BINDING' | 'PENDING_DELETE' | 'PENDING_CREATE' | 'PENDING_UPDATE' | 'DOWN' | 'ACTIVE' | 'ELB' | 'ERROR';
    /**
...
export declare function listPublicIPs(client: HttpClient): Promise<PublicIP[]>;
