...
exports.showAccountMetadata = exports.updateAccountMetadata = exports.getAccount = void 0;
 ...
 */
function updateAccountMetadata(client, metadata, quota) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.updateAccountMetadata = updateAccountMetadata;
function showAccountMetadata(client) {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield client.head({ url: url });
        return parseAccountHeaders(resp.headers);
    });
}
exports.showAccountMetadata = showAccountMetadata;
